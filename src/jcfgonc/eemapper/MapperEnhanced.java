...
public class MapperEnhanced {
	public static void main(String[] args) throws Exception {
		...
		String mappingsFilename = VariousUtils.generateCurrentDateAndTimeStamp() + "_mappings.csv";
	...
	public void executeSingle(String filename) throws Exception {// one mappingset per chromosome
		...
		mapStruct.writeTGF(VariousUtils.generateCurrentDateAndTimeStamp() + "_mapping.tgf");
	}
